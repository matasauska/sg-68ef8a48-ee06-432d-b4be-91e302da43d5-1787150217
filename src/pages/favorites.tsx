  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="font-display text-3xl font-bold mb-2">{t("nav.favorites")}</h1>
        <p className="text-muted-foreground mb-8">{t("dashboard.savedListings")}</p>
        ...
        {favorites.length === 0 ? (
          <div className="text-center py-16 bg-muted/30 rounded-2xl">
            ...
            <Button asChild>
              <Link href="/browse">{t("nav.animals")}</Link>
            </Button>
          </div>
        ) : (
